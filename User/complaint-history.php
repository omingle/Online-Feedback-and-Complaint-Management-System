                      ...
                      <div class="content-panel">
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
  <?php $query=mysqli_query($con,"select * from tblcomplaints where userId='".$_SESSION['idcode']."'");
...
<?php } ?>
                                   <td align="center">
                                   <a href="complaint_details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
