    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="http://localhost:8080/Project%20Folder/admin/index.php">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <h6 class="dropdown-header">Add or Delete</h6>
            <a class="dropdown-item" href="login.html">Delete Student</a>
            <a class="dropdown-item" href="add_faculty.php">Add Faculty</a>
            <a class="dropdown-item" href="forgot-password.html">Create Admin</a>
            <div class="dropdown-divider"></div>
            <h6 class="dropdown-header">Send Notification</h6>
            <a class="dropdown-item" href="Add_event.php">Add Event</a>
            <a class="dropdown-item" href="personal_message.php">Personal Messages</a>
          </div>
          <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="login.html">Girls Hostel</a>
            <a class="dropdown-item" href="register.html">Boys Hostel</a>
