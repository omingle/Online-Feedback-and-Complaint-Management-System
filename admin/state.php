...
?>									
										<tr>
											...
											<td>
											<a href="edit-state.php?id=<?php echo $row['id']?>" ><i class="fas fa-globe"></i></a>
											<a href="state.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fas fa-theater-masks"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
